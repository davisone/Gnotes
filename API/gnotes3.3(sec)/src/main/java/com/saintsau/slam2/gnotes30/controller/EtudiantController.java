...
public class EtudiantController {
    ...
    public List<EntityModel<User>> getAllEtudiants() {
        ...
        return userService.getAllUsers().stream()
                .filter(user -> user.getRole() != null && "ETUDIANT".equals(user.getRole().getLibelle()))
                .map(user -> {
                    ...
                    resource.add(linkTo(methodOn(UserController.class).getUserById(user.getId())).withRel("user-details"));
                    return resource;
                })
